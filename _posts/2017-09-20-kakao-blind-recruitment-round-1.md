...
여기서부터 문제가 좀 어려워졌던 거 같습니다. 정답률이 많이 낮은데요. 이 문제는 조건에도 나와있지만 LRU 캐시 교체 알고리즘을 구현하는 문제이고, 이미 잘 알고 있다면 또는 검색해봤다면 잘 구현된 LRU 알고리즘 코드를 많이 찾을 수 있습니다.
...
참여하신 분들 중 미처 풀지 못한 문제가 있었다면 문제 해설을 보면서 '조금만 더 시간이 있었더라면...'라며 안타까움을 느끼는 분들이 많으실 거라 생각합니다. 여타의 코딩 대회와 달리 채용을 위한 시험인 만큼 재밌게 즐기기는 힘들었겠지만 옛말에 "천재는 노력하는 사람을 이길 수 없고, 노력하는 사람은 즐기는 사람을 이길 수 없다."는 말이 있습니다. 끝까지 즐기는 마음 잊지 마시고 마지막까지 코딩을 즐기신다면 좋은 결과 있으리라 확신합니다. 잘 마무리하여 꼭 카카오에서 여러분들을 만나 뵙게 되길 기대하겠습니다.
