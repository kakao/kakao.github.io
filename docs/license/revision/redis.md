...
> **참고하기**
>
> - FAQ는 [https://redis.io/blog/redis-adopts-dual-source-available-licensing/](https://redis.io/blog/redis-adopts-dual-source-available-licensing/){:target="_blank"} 하단에서 확인할 수 있습니다.
{: .fs-3}

### 2차 라이선스 변경 (2025.05.01 - Redis 8 출시)
...
Redis 7.2 이하의 오픈소스 버전을 사용하되, Redis에서 제공한 코드나 바이너리를 수정 없이 그대로 사용하는 경우 영향을 받지 않습니다.<br><br>
